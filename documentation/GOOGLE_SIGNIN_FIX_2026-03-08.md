...
## 🔧 Certificats obtenus pour ce projet
...
**Valide jusqu'à:** samedi 19 février 2056
...
- Ces certificats sont pour le **debug keystore** uniquement
- Pour une version de **production**, vous devrez générer un **release keystore** et ajouter ses SHA également
- Gardez toujours une copie de vos keystores et certificats
- N'oubliez pas d'ajouter le `serverClientId` dans le code Flutter si nécessaire
