...
class _BusinessOnboardingScreenState extends State<BusinessOnboardingScreen>
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      ...
      subtitle: 'Advanced features for tour companies',
      description: 'Manage multiple guides, track performance, and optimize your operations',
      icon: Icons.business,
      color: const Color(0xFF9B59B6),
      image: 'assets/images/onboarding/business/management.png',
    ),
    OnboardingPage(
      title: 'Team Collaboration',
      subtitle: 'Coordinate with your entire team',
      description: 'Assign guides, manage schedules, and communicate seamlessly with your staff',
      icon: Icons.groups,
      color: const Color(0xFF4B63FF),
      image: 'assets/images/onboarding/business/team.png',
    ),
    OnboardingPage(
      title: 'Advanced Analytics',
      subtitle: 'Data-driven insights for growth',
      description: 'Track bookings, revenue, customer satisfaction, and optimize your business strategy',
      icon: Icons.analytics,
      color: const Color(0xFF00B894),
      image: 'assets/images/onboarding/business/analytics.png',
    ),
    OnboardingPage(
      title: 'Enterprise Support',
      subtitle: 'Dedicated support for your business',
      description: 'Get priority support, custom solutions, and personalized assistance for your company',
      icon: Icons.support_agent,
      color: const Color(0xFFFFA502),
      image: 'assets/images/onboarding/business/support.png',
    ),
  ];
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        widget.isLastPage ? 'Go to Dashboard' : 'Next',
