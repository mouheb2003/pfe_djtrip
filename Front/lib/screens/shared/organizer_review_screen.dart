...
class _OrganizerReviewScreenState extends State<OrganizerReviewScreen> {
  ...
  Widget _buildActivityRatingDisplay() {
    return Container(
        ...
        children: [
          ...
          Row(
            children: List.generate(5, (index) {
              return Icon(
                index < widget.activityRating ? Icons.star : Icons.star_border,
                color: Colors.amber,
                size: 20,
              );
            }),
          ...
          const SizedBox(height: 4),
          Text(
            '${widget.activityRating.toStringAsFixed(1)} stars',
            style: const TextStyle(
              fontSize: 12,
              color: Color(0xFF4B63FF),
              fontWeight: FontWeight.w600,
...
class ThankYouScreen extends StatelessWidget {
  ...
  final double rating;
  final bool isOrganizerReview;

  const ThankYouScreen({
    super.key,
    required this.activityTitle,
    required this.rating,
    this.isOrganizerReview = false,
  });
