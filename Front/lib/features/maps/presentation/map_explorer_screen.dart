...
class _MapExplorerScreenState extends State<MapExplorerScreen> {
  ...
  Future<void> _loadLieuxFromBD() async {
    try {
      ...
      setState(() {
        _lieuxFromBD = lieux.where((l) => l.latitude != null && l.longitude != null).toList();
      });
    } catch (e) {
    ...
    for (final lieu in _lieuxFromBD) {
      ...
      if (_selectedFilter != 'all') {
        ...
        if (filterType == 'restaurant') {
          isMatch = lieuType.contains('restaurant') || lieuType.contains('restaurants');
          ...
          isMatch = lieuType.contains('hotel') || lieuType.contains('accommodation') || lieuType.contains('lodging');
          ...
          isMatch = lieuType.contains('shopping') || lieuType.contains('store') || lieuType.contains('mall');
        } else if (filterType == 'mosque') {
          isMatch = lieuType.contains('mosque') || lieuType.contains('mosques');
        } else if (filterType == 'tourist_attraction') {
          isMatch = lieuType.contains('tourist') || lieuType.contains('attraction') || lieuType.contains('activity') || lieuType.contains('activities');
        } else {
        ...
        // Debug print
        // ignore: avoid_print
        print('[MapExplorer] Lieu BD: "${lieu.titre}" - categorie: "$lieuType" - filter: "$filterType" - match: $isMatch');
          ...
          if (index == 0) {
            ...
            return Padding(
              ...
              child: FilterChip(
                ...
                side: BorderSide(
                  color: _selectedFilter == 'all' ? AppColors.primary : AppColors.outline,
                ),
                onSelected: (selected) {
                  setState(() {
                    _selectedFilter = 'all';
