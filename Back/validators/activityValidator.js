...
const createActivitySchema = Joi.object({
  ...
  type_activite: Joi.string()
    .valid(
      'Guided Tour', 'Excursion', 'Hiking', 'Adventure', 'Culture',
      'Gastronomy', 'Sport', 'Other', 'Water Sports', 'Climbing',
      'Cycling', 'Cultural Visits', 'Extreme Sports', 'Courses and Workshops',
      'Relaxation and Wellness', 'Photography', 'Nature Observation',
      'Winter Sports', 'Water Activities', 'Excursions', 'Others'
    )
    .required()
    .messages({
  ...
  niveau_difficulte: Joi.string()
    ...
    .default('Easy')
    .optional(),
  equipements_inclus: Joi.array()
    .items(Joi.string())
    .max(20)
    .optional(),
  a_apporter: Joi.array()
    .items(Joi.string())
    .max(20)
    .optional(),
  dates_disponibles: Joi.array()
    .items(Joi.date().iso())
    .optional(),
  date_debut: Joi.date()
    .iso()
...
const activityListQuerySchema = Joi.object({
  ...
  niveau_difficulte: Joi.string().valid('Easy', 'Moderate', 'Difficult', 'Expert').optional(),
  statut: Joi.string().valid('active', 'inactive', 'archived', 'completed').optional(),
