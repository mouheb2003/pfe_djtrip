...
// Schéma spécifique pour Organisator (Organisateur d'activités uniquement)
const organisatorSchema = new mongoose.Schema({
  ...
  // Nombre d'activités créées par cet organisateur
  nombre_activites: {
    type: Number,
    default: 0,
  },
  ...
  // Capacité max de participants par activité (en moyenne)
  capacite_moyenne: {
    type: Number,
  },
